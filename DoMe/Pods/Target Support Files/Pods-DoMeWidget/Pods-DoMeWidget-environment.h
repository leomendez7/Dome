...
#define COCOAPODS_POD_AVAILABLE_SWRevealTableViewCell
#define COCOAPODS_VERSION_MAJOR_SWRevealTableViewCell 0
#define COCOAPODS_VERSION_MINOR_SWRevealTableViewCell 3
#define COCOAPODS_VERSION_PATCH_SWRevealTableViewCell 5
